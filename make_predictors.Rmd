...
```{r}
y_erq = read_csv("mental-health/mh_y_erq.csv")
```
...
```{r}
y_upps <- read_csv("mental-health/mh_y_upps.csv")
```
...
```{r}
y_pps <- read_csv("mental-health/mh_y_pps.csv")
```
...
```{r}
y_bisbas <- read_csv("mental-health/mh_y_bisbas.csv")
```
...
```{r}
p_eatq <- read_csv("mental-health/mh_p_eatq.csv")
```
...
```{r}
t_bpm <- read_csv("mental-health/mh_t_bpm.csv")
```
...
```{r}
y_bpm <- read_csv("mental-health/mh_y_bpm.csv")
```
...
```{r}
y_cbb <- read_csv("mental-health/mh_y_cbb.csv")
```
...
```{r}
y_ksads_bg <- read_csv("mental-health/mh_y_ksads_bg.csv")
```
...
```{r}
y_or <- read_csv("mental-health/mh_y_or.csv")
```
...
```{r}
y_peq <- read_csv("mental-health/mh_y_peq.csv")
```
...
```{r}
y_poa <- read_csv("mental-health/mh_y_poa.csv")
```
...
```{r}
p_ders <- read_csv("mental-health/mh_p_ders.csv")
```
